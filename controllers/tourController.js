...
//function to calculate couple of statistics about tours
exports.getTourStats = async (req, res) => {
  try {
    //in aggregate we pass array of stages and this document will pass stages by stages and each of the stages is an object
    ...
    console.log(stats); //need to check why it is giving empty array
    res.status(200).json({
      status: 'success',
      data: {
        stats
